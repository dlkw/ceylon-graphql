...
public interface GraphQLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#object}.
	 * @param ctx the parse tree
	 */
	void enterObject(GraphQLParser.ObjectContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#object}.
	 * @param ctx the parse tree
	 */
	void exitObject(GraphQLParser.ObjectContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#enumConstant}.
	 * @param ctx the parse tree
	 */
	void enterEnumConstant(GraphQLParser.EnumConstantContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#enumConstant}.
	 * @param ctx the parse tree
	 */
	void exitEnumConstant(GraphQLParser.EnumConstantContext ctx);
}