...
public class GraphQLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GraphQLVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitObject(GraphQLParser.ObjectContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitEnumConstant(GraphQLParser.EnumConstantContext ctx) { return visitChildren(ctx); }
}